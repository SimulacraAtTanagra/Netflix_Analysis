...
df =pd.read_excel("c:\\users\\shane\\downloads\\originals.xlsx")
df.columns = df.columns.str.strip().str.lower().str.replace(' ', '_').str.replace('(', '').str.replace(')', '')
df.type= df.type.apply(fixend)
genres= pd.read_excel("c:\\users\\shane\\downloads\\genres.xlsx")
...
total =pd.read_excel("c:\\users\\shane\\downloads\\ratings.xlsx")
